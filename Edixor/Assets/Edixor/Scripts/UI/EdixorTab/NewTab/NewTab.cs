...
{
    [MenuItem("Window/Edixor Tab/New Tab")]
    ...
    {
        tabName = "New Tab";
        LoadUxml("Assets/Edixor/Scripts/UI/EdixorTab/NewTab/NewTab.uxml");
        LoadUss("Assets/Edixor/Scripts/UI/EdixorTab/NewTab/NewTab.uss");
    }
