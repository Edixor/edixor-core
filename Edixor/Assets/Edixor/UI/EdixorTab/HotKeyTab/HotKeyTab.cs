...
public class HotKeysTab : EdixorTab
{
    ...
    public HotKeyTab(VisualElement ParentContainer, EdixorUIManager edixorUIManager) : base(ParentContainer) {
        this.edixorUIManager = edixorUIManager;
    }

    public override string Title => "HotKey";
    public override string PathUxml => "Assets/Edixor/UI/EdixorTab/HotKeyTab/HotKeyTab.uxml";
    public override string PathUss => "Assets/Edixor/UI/EdixorTab/HotKeyTab/HotKeyTab.uss";
